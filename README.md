...
- 修复`exports { default } from 'xxx'`解释报`default`是保留字的错误问题

\### (2019-12-30)

- v0.3.15
  - 修复`class a extend b`格式解释错误的问题

- v0.3.14 
  - 支持`export * from 'xxx'`格式
  - 解决`module.exports=` exports 被修改的问题
  - 修复某些 node_modules 模块路径识别错误的问题
  - 修复`export { a, b as bb }`带有 as 和无 as 混合格式导出
  - 修复手动清空浏览器缓存出现白屏的问题
